...
def response_method_not_allowed():
    ...
    return b"\r\n".join([
        ...
        b"",
        b"You are not allowed to do this on my server!!"
    ])
...
def response_not_found():
    ...
    return b"\r\n".join([
        ...
        b"",
        b"What you looking for are not found on my server!!"
    ])
...
def response_path(path):
    ...
    if os.path.isdir(path):
        for filename in os.listdir(path):
            content = content + filename.encode("utf-8") + b"\r\n"
